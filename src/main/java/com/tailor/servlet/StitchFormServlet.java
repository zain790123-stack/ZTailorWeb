...
public class StitchFormServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String uploadDir = "C:/Users/Zain Ul Abidin/eclipse-workspace/ZTailor/src/main/webapp/uploads/custom_tailor"; 
        ...
        try {
            ...
            String sql = "INSERT INTO suit_requests (garment,request_id, slai, deadline, customer_name, customer_phone, customer_whatsapp, customer_address, additional_notes,tailor_name, cloth_image) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
